...
#    docker run -i msSql-flyway -url="jdbc:sqlserver://$SQL_DOCKER_NAME:$SQL_PORT;instanceName=SQLEXPRESS;databaseName=PlanManagement;" -locations="filesystem:/var/flyway" -user=sa -password=Password123! -connectRetries=10 migrate
